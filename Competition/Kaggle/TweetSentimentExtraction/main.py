...
train_dataloader = DataLoader(TweetDataset(df_train['text'], df_train['selected_text'], df_train['sentiment']),
    ...
    for i in range(config.EPOCH):
        ...
        for i, data in enumerate(tk0):
            ...
            for p_i, tweet in enumerate(data['tweet']):
                jaccard_s = calculate_jaccard_score(tweet, data['selected'][p_i], output_start[p_i], output_end[p_i],
                                                    data['tweet_off'][p_i])
